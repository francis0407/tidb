...
func (s *testTransformationRuleSuite) SetUpSuite(c *C) {
	...
	var err error
	s.testData, err = testutil.LoadTestSuiteData("testdata", "transformation_rule_suite")
	c.Assert(err, IsNil)
}
...
func (s *testTransformationRuleSuite) TestEliminateSingleProjection(c *C) {
